...
#Order of argument
../build/logappend -T 1 -K secret -E Fred -A log1
...
rm -f log1
rm -f .logdb
../build/logappend -T 1 -K secret -A -G Fred log1
../build/logappend -T 2 -K secret -A -G Jane log1
...
../build/logappend -T 1 -K secret1 -A -G Jane log1
...
../build/logappend -T 1 -K secret0 -N -G Fred log1
...
../build/logappend -T 2 -K secret1 -A -R a -G Fred log1
...
../build/logappend -T 1 -K secret1 -A -G Fred log1
../build/logappend -T 2 -K secret1 -A -G fred log1
...
../build/logappend -T 3 -K secret1 -L -G fred1 log1
../build/logappend -T 4 -K secret1 -L -G fred log1
